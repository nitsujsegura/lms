...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2023 at 11:42 AM
...
INSERT INTO `admin1` (`admin_id`, `username`, `password`, `fname`, `lname`) VALUES
(1, 'justin', '$2y$10$bX7G9fPu1vd6dhRfHKu3d.xhvajZ4ABK5Vhruy8CL9mp65Lm3jCBS\r\n', 'a', 'a');
...
INSERT INTO `grade_1` (`grade1_id`, `username`, `password`) VALUES
(1, 'carl', '$2y$10$bX7G9fPu1vd6dhRfHKu3d.xhvajZ4ABK5Vhruy8CL9mp65Lm3jCBS\r\n');
...
--
ALTER TABLE `grade_1`
  MODIFY `grade1_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
